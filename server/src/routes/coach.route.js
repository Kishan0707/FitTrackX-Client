...
router.get("/plans", protect, authorizeRoles("coach", "admin"), planController.getAllPlans);
router.post("/plans", protect, authorizeRoles("coach", "admin"), planController.createPlans);
router.post(
  "/plans/assign",
  protect,
...
router.put("/plans/:id", protect, authorizeRoles("coach", "admin"), planController.updatePlan);
router.delete("/plans/:id", protect, authorizeRoles("coach", "admin"), planController.deletePlan);
router.get("/client-detail/:userId", protect, authorizeRoles("coach"), coachController.clientDetail);
router.get("/report", protect, authorizeRoles("coach"), coachController.coachReport);
